    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(id="config-dialog"):
            ...
            with VerticalScroll(id="page-body"):
                ...
                yield Static(
                    "Builtin is the safe default. Graphify is optional, local-only and must be installed separately.",
                    classes="hint",
                )
                yield Select(
                    [("Builtin exact-source mapping", "builtin"), ("Graphify structural candidates", "graphify")],

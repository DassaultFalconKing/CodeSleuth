...
required = [
    ...
    "opencode.json", "codesleuth.json", "codesleuth-user.json", "codesleuth-naming.json", "CODESLEUTH-REPORTS.md"
]
...
print("floating update check: .opencode/bin/codesleuth-update --check")

...
AGENTS_POINTER = textwrap.dedent(
    ...
    Format details for analytical reports remain in `.opencode/CODESLEUTH-REPORTS.md`. Reports are local-only by default because they may contain source excerpts or credentials; reuse them in this worktree, and only publish sanitized reports or guidance intentionally.
    {AGENTS_END}
    """
)

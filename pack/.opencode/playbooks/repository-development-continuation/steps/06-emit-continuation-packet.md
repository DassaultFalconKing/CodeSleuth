...
The state tool must reject the packet if confirmed canonical planning authority or confirmed active implementation scope is absent. Do not work around that stop.

...
async function main() {
  ...
  try {
    ...
    assert(dryInvalid.violationCount === 4, "all independent semantic violations are returned in one round trip")
    ...
    assert(thrown.includes("4 violation(s)"), "normal save throws one consolidated validation error")

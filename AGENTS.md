# CodeSleuth operator guide for coding agents

<!-- README-SOURCE-BLOB: 6ac73280f626752b8d52a30da5f35883525bb21d -->

Read this file when a user asks you to install, configure, use, update, remove, or reason about CodeSleuth. It is the cross-agent operating guide for the current repository version. `README.md` remains the canonical product/manual surface. When this file and current source disagree, verify the source and follow the source.
...
- [`docs/PROJECT-LIFECYCLE.md`](docs/PROJECT-LIFECYCLE.md): install/bind/unbind/uninstall and restoration rules;
- [`docs/CODESLEUTH-PRODUCT-CONTRACT.md`](docs/CODESLEUTH-PRODUCT-CONTRACT.md): product/runtime ownership and frozen-core boundaries;
- [`docs/NOVACLAW-MCP.md`](docs/NOVACLAW-MCP.md): current external-host MCP boundary;
...
This file intentionally tracks the canonical English `README.md` through the `README-SOURCE-BLOB` marker near the top.
...
2. update this file when those changes affect agent operation;
